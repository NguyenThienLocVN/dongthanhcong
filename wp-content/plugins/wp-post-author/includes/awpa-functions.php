                    ...
                    <ul class="awpa-contact-info <?php echo esc_attr($icon_shape); ?>">
                        <?php foreach ($contact_info as $key => $value) : ?>
                            ...
                            <?php else : ?>
                                ...
                                <li class="awpa-<?php echo $key; ?>-li">
                                    <a href="<?php echo $value; ?>" rel="nofollow" class="awpa-<?php echo esc_attr($key); ?> awpa-icon-<?php echo $key; ?>"></a>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </ul>
                    ...
                    <ul class="awpa-contact-info <?php echo esc_attr($icon_shape); ?>">
                        ...
                        if (!empty($guest_user_data->user_meta)) {
                            ...
                            foreach ($social_links as $key => $value) {
                                if (!empty($value)) { ?>
                                    <li class="awpa-<?php echo $key; ?>-li">
                                        <a href="<?php echo esc_url($value); ?>" target="_blank" rel="nofollow" class="awpa-<?php echo esc_attr($key); ?> awpa-icon-<?php echo $key; ?>"></a>
                                    </li>
                        <?php }
                            }
                        }
                    ...
                    <ul class="awpa-contact-info <?php echo esc_attr($social_icon); ?>">
                        <?php foreach ($contact_info as $key => $value) : ?>
                            ...
                            <?php else : ?>
                                ...
                                <li class="awpa-<?php echo $key; ?>-li">
                                    <a href="<?php echo $value; ?>" rel="nofollow" class="awpa-<?php echo $key; ?> awpa-icon-<?php echo $key; ?>"></a>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </ul>
